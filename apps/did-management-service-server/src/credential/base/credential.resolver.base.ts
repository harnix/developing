...
export class CredentialResolverBase {
  ...
  @graphql.ResolveField(() => Did, {
    nullable: true,
    name: "did",
  })
  async getDid(@graphql.Parent() parent: Credential): Promise<Did | null> {
    const result = await this.service.getDid(parent.id);
